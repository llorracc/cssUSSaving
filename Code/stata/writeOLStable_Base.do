...
#delimit;
tempname hh;
file open `hh' using "$docPath\tOLS_prelim_time.tex", write replace;
file write `hh' "  "_n;

file write `hh' "\begin{table}" _n;
file write `hh' "\caption{ Preliminary Saving Regressions and the Time Trend} \label{tOLSprelim} \small " _n;
