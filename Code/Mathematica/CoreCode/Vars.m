...
\[ScriptV]E=(u[\[ScriptC]E] + \[Beta] (\[CapitalGamma]^(1-\[Rho])) \[Mho] vUPF[\[ScriptA]E \[ScriptCapitalR]+Severance])/(1-\[Beta] (\[CapitalGamma]^(1-\[Rho]) (1-\[Mho])));
\[ScriptM]MinBound=1-Severance/\[ScriptCapitalR];
