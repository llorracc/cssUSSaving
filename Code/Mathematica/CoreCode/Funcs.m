...
(* Find limiting MPC as \[ScriptM] approaches its minimum possible value, using eq:natural and nearby results in lecture notes *)
...
,\[ScriptM]Buffer=\[ScriptM]E-\[ScriptM]MinBound,\[ScriptM]MaxPermitted=\[ScriptM]MinBound+\[ScriptM]MaxMultiple*\[ScriptM]Buffer,Counter = 0,PointsList =InitialPoints
},
...
\[ScriptM]EMin=-Severance/\[ScriptCapitalR];
cEPoints = Join[{{{\[ScriptM]EMin},0.,\[Kappa]EMax,\[Kappa]EPAtZero}},Transpose[{Partition[\[ScriptM]Vec,1],\[ScriptC]Vec,\[Kappa]Vec,\[Kappa]PVec}]];
