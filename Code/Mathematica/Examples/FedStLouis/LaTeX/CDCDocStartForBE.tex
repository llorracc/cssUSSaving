...
\else
    ...
    \newcommand{\CDCFig}[1]{\centerline{\includegraphics[width=0.75\textwidth]{\econtexRoot/Figures/#1}}}
    \newcommand{\CDCFigSideways}[1]{\centerline{\includegraphics[width=7.8in,height=5.5in]{\econtexRoot/Figures/#1}}}
