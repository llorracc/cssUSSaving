...
function [cRescaled,actualC,mhoRescaled,debtLimPDVrescaled,cRescaledFull,mRescaledFull] = minCdist_outputSeries_pars4_mho(thetaVec, data);
...
debtLimPDVrescaled = scaleFac1_CEA*CEAseries;
